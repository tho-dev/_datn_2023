...
import { useGetAllProductManagerQuery } from "~/redux/api/product";
...
const ActionPromotion = ({ onClose }: Props) => {
  ...
  const onSubmit = async ({ category, brand, ...values }: any) => {
    values = {
      ...values,
      status: JSON.parse(values?.status?.value || ""),
  ...
  const columns = [
    columnHelper.accessor("#", {
      cell: ({ row }) => {
        ...
        return <Checkbox value={doc._id} name="items" />;
      },
      header: "#",
    }),
    columnHelper.accessor("name", {
      cell: ({ getValue }) => {
        return (
          <Text fontSize="13px" fontWeight="medium" display="inline-block">
            {getValue()}
          </Text>
        );
      },
      ...
      <Flex flexDir="column" gap="4">
        ...
        <Flex mt="6" gap="6">
          ...
          <Flex flexDir="column" gap="4" flex="1">
            <FormControl>
              <FormLabel fontSize="15" fontWeight="semibold">
              ...
              <Button
                ...
                bgColor="bg.bgEdit"
                color="text.textEdit"
                leftIcon={<AppIcon size={5} color="text.textEdit" />}
        ...
        <Box>
          ...
          <Controller
            ...
            render={({
              ...
              <FormControl isInvalid={!!error} id="items">
                <CheckboxGroup {...field}>
                  <TableThinkPro
                    columns={columns}
