            ...
            <GridItem colSpan={5}>
              <Flex gap="6" flexDir="column">
                ...
                <CommonBox title="Danh Sách Biến Thể">
                  <Flex gap="4" flexDir="column" maxH="480px" overflowY="auto">
                    {variants?.data.map((variant: any, k: number) => {
                      ...
                      return (
                        <Flex
                          ...
                          rounded="md"
                          bgColor={
                            sku_id == variant?._id ? "bg.gray" : "transparent"
                          }
                          borderWidth="1px"
                        ...
                        >
                          ...
                          <Box>
                            <Flex gap="1" flexWrap="wrap" height="fit-content">
                ...
                <CommonBox title="Các Thuộc Tính">
                  <Flex gap="4" flexDir="column">
                    {fields.map((field: any, index: number) => {
                      ...
                      return (
                        <Flex key={field.id} gap="3" flexDir="column">
                          <FormControl
                            isInvalid={
                              `errors?.options?.[${index}].label` as any
                            }
                          >
                            <FormLabel
                              htmlFor="name"
                            ...
                            <Input
                              {...register(
                                `options.${index}.option_value.label`,
                                {
                          ...
                          <FormControl
                            key={field.id}
                            isInvalid={
                              `errors?.options?.[${index}].value` as any
                            }
                            display="flex"
                            alignItems="center"
                            gap="4"
                          >
                            <Input
                              {...register(
                                `options.${index}.option_value.value`,
                                {
                                  required: "Không được để trống",
                                }
                              )}
