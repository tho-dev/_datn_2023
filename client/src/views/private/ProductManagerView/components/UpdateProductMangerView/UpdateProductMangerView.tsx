...
const UpdateProductMangerView = () => {
  ...
  useEffect(() => {
    if (categories) {
      const selectCategories = categories?.data?.items?.map(
        (category: any) => ({
          label: category?.name,
          value: category?._id,
        })
  ...
  return (
    <Box w="full" h="full" bgColor="bg.white" py="8" px="6" rounded="xl">
      <Heading
        fontSize="18"
        color="text.black"
        lineHeight="100%"
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Box w="full" h="full" my="6" rounded="lg" bgColor="bg.white">
            ...
            <GridItem colSpan={9}>
              ...
              <Flex gap="6" flexDir="column">
                  ...
                  <Flex gap="4" flexDir="column">
                    ...
                    <FormControl isInvalid={errors?.description as any}>
                      ...
                      <QuillThinkPro
                        data={description}
                        onEditorStateChange={
                          onEditorStateChangeDescription as any
                        }
                      />
                      <FormErrorMessage>
                ...
                <CommonBox title="Biến Thể">
                  <Variants watch={watch} variants={variants} />
                </CommonBox>
                {/* SEO */}
                ...
                <CommonBox title="Thông tin giá">
                  <Flex flexDir="column" gap="4">
                    <FormControl isInvalid={errors?.price_import as any}>
                      ...
                      <FormErrorMessage>
                        {(errors?.price_import as any) &&
                          errors?.price_import?.message}
                      </FormErrorMessage>
                    </FormControl>
                    ...
                    <FormControl
                      isInvalid={errors?.price_before_discount as any}
                    >
                      <FormLabel
                  ...
                  <Flex flexDir="column" gap="4">
                    <Controller
                      ...
                      render={({
                        ...
                        <FormControl isInvalid={!!error} id="has_gift">
                          <FormLabel
                            htmlFor="has_gift"
                            fontSize="sm"
                            fontWeight="semibold"
                    ...
                    <Controller
                      ...
                      render={({
                        ...
                        <FormControl isInvalid={!!error} id="status">
                          <FormLabel
                            htmlFor="status"
                            fontSize="sm"
                            fontWeight="semibold"
                    ...
                    <Controller
                      ...
                      render={({
                        ...
                        return (
                          <FormControl isInvalid={!!error} id="is_avaiable">
                            <FormLabel
                              htmlFor="is_avaiable"
                              fontSize="sm"
                              fontWeight="semibold"
