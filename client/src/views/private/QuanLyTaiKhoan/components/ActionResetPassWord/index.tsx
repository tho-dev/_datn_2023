...
import { useResetPasswordMutation } from "~/redux/api/coupon";
...
const ActionResetPassWordView = ({ onClose, AccDetail }: Props) => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      await resetPassword(newDataPassWord).unwrap();
      toast({
        title: "Thành công",
        duration: 1600,
        position: "top-right",
...
export default ActionResetPassWordView;
