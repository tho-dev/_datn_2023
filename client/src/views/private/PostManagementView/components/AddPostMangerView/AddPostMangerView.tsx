        ...
        <GridItem colSpan={12}>
          <FormControl isInvalid={errors.file as any}>
            <Flex justifyContent="center" mt="8">
              <Box w="50%" h="260px" rounded="2xl" overflow="hidden">
                <FileUploadThinkPro
                  fileName="banner"
        ...
        <GridItem colSpan={9}>
          ...
          >
            <FormControl isInvalid={errors.title as any}>
              <FormLabel htmlFor="title" fontSize="15" fontWeight="semibold">
                Tiêu đề
              </FormLabel>
              <Input
                id="title"
            ...
            <FormControl isInvalid={errors.content as any}>
              <FormLabel fontSize="15" htmlFor="content" fontWeight="semibold">
                Mô tả
              </FormLabel>
              <QuillThinkPro
                data={content}
