...
import { FilterIcon, PlusCircleIcon, SearchAdminIcon, SearchIcon } from "~/components/common/Icons";
...
const OrderFilter = ({ handleSearch, search, handleDate, handleStatus, handlePayment }: Props) => {
