...
const UpdateOrder = (props: Props) => {
	...
	const submitForm = (order_infor: any) => {
		...
		const shipping_address = order_infor.address_detail + "," + order_infor.shipping_address;
		if (!phone_number) {
							...
							<Flex gap={"16px"}>
								...
								<FormControl>
									...
									<Input
										...
										defaultValue={chuyenDoiSoDienThoaiVe0(data?.data?.phone_number)}
									/>
								</FormControl>
							</Flex>
								...
								>
									...
									<FormControl>
										...
										<Input
											...
											defaultValue={data?.data?.shipping_info?.shipping_address.split(",")[0]}
										/>
					...
					>
						...
						>
							...
							>
								{data?.data?.products
									.reduce(
										(accumulator: any, currentValue: any) => accumulator + currentValue.total_money,
										0
									)
									.toLocaleString()}
								đ
						...
						>
							...
							<Text
								...
								fontWeight="semibold"
							>
								{data?.data.shipping_method === "shipped" ? transportFee.toLocaleString() : 0}đ
							</Text>
						</Flex>
						<Divider />
						<Flex
