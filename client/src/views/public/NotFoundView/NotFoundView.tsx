...
import { Box, Center, Flex, Heading, Image, UnorderedList, ListItem, Text, Link, Button } from "@chakra-ui/react";
			...
			>
				...
				<Box mt="4">
					...
					<UnorderedList fontSize="sm">
						...
						<ListItem>Thanh URL bị gõ nhầm một ký tự nào đó (bạn thử check lại xem nhé)</ListItem>
