          ...
          <ModalBody mx={"2"}>
            <Flex gap={"6"}>
              ...
              <Box w={"70%"}>
                ...
                <Text as={"p"} fontSize={"sm"} py={"3"}>
                  Đánh giá này dựa trên các chuyên gia máy tính từ ThinkPro. Qua
                  các bài kiểm tra và kinh nghiệm thực tế sử dụng, có tham khảo
                  đánh giá từ các chuyên trang đánh giá trong và ngoài nước.
                </Text>
