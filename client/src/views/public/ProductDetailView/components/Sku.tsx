	...
	return (
		<>
			<Box bgColor={"white"} rounded={"6px"} p="6" mt="4">
				<Text fontSize={"sm"} rounded={"6px"} color="text.black" fontWeight="medium">
				...
				<Box>
					...
					<Text fontSize={"14px"} fontWeight="semibold" color={"#6B7075"} mt="2">
						Màu
					</Text>
					{/* Màu */}
					<Flex gap="3" mt="2" flexWrap="wrap">
					...
					<Flex mt="2" gap={"3"} flexWrap={"wrap"}>
						<Tooltip hasArrow label={tooltiptext} bg="bg.gray" color="text.black">
							<Button
								bg={"#EBF3FF"}
								color={"#0065EE"}
								border={"#0065EE 1px solid"}
					...
					<Grid templateColumns="repeat(3, 1fr)" gap={4}>
						...
						<GridItem>
							<Button fontSize={"sm"} fontWeight={600} color={"#0065EE"} bg={"#F5F6FC"}>
								Thêm vào giỏ
							</Button>
						</GridItem>
						<GridItem>
