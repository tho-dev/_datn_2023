    ...
    <Center h='full' px={{ sm: 5, md: 5, lg: 0, xl: 0, '2xl': 0 }}>
      <Flex w='460px' h='full' direction='column' pt='8'>
        ...
        >
          <Flex direction='column' gap='4'>
            ...
            <FormControl isInvalid={errors.password as any}>
              <Input id='password' type='password' placeholder='Password' size='lager' {...register('password')} />
        ...
        <Flex w='full' direction='column' gap='4'>
          <Button size='lager' leftIcon={<GoogleIcon boxSize='5' />} w='full' bgColor='white' color='text.200' rounded='full' border='1px solid' borderColor='text.300'>
            Đăng nhập bằng Google
          </Button>
          <Button size='lager' leftIcon={<FbIcon boxSize='5' />} w='full' bgColor='white' rounded='full' color='text.200' border='1px solid' borderColor='text.300'>
