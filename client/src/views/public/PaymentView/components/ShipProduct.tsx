		...
		<Box mt={"12px"}>
				...
				<FormControl isInvalid={errors?.payment as any}>
					...
					<RadioGroup onChange={setValue} value={value}>
						<Stack direction="row" gap={"16px"} spacing={4}>
							<Radio value="tructiep" fontSize={"12px"} {...registerShip("payment")}>
								Thanh toán khi nhận hàng
							</Radio>
							<Radio value="online" fontSize={"12px"} {...registerShip("payment")}>
								Thanh toán online
							</Radio>
						</Stack>
					</RadioGroup>
			...
			<Box mt={"16px"}>
				<FormControl isInvalid={errors?.storeAddress as any}>
					...
					<RadioGroup onChange={setValueAddress} value={valueaddress} {...registerShip("storeAddress")}>
