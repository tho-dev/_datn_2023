    ...
    <>
      <Box mt="12">
        ...
        >
          ...
          <Text color="#6b7075" fontSize="2xl" fontWeight="semibold">
            {text}
          </Text>
        </Flex>
        <Grid
        ...
        >
            ...
            return (
              <GridItem key={index}>
                ...
                >
                  ...
                  <Box w="20" h="20" position="absolute" right="3" bottom="3">
                    <Image
                      w="full"
                      h="full"
                      src={item?.image}
          ...
          <GridItem>
            ...
            >
              <Box as="span">
                <CheckOneIcon size={5} color="#3bb346" />
              </Box>
              <Text
                mt="2"
                fontSize="xs"
                ...
                fontWeight="semibold"
              >
                Thành viên thuộc Onward Together Group. Tập đoàn bán lẻ từ 2013
                với nguyên tắc hoạt động: Khách hàng là trung tâm.
              </Text>
            </Box>
          </GridItem>
        </Grid>
