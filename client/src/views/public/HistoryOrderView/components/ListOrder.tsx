...
import { NavArrowLeflIcon, NavArrowRightIcon } from "~/components/common/Icons/index";
...
const ListOrder = ({ dataOrder, phoneNumber, setQuery, paginate, loading }: Props) => {
											...
											>
												<Box>
													...
													<Text
														...
														fontWeight={"bold"}
													>
														Ngày đặt : {moment(item?.created_at).format("DD-MM-YYYY hh:mm")}
													</Text>
													<Text
														as={"p"}
														fontSize={"14px"}
