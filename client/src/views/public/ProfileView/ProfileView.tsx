import { Box, Divider, Flex, Heading, Image, Tab, TabList, TabPanel, TabPanels, Tabs, Text, IconButton, Tooltip } from '@chakra-ui/react';
    ...
    <Box my='6' px='6' py='4' rounded='xl' bgColor='bg.white'>
      ...
      <Box my='6'>
        <Flex alignItems='center' gap='6'>
          <Box>
            <Image rounded='full' boxSize='120px' src={user?.avatar} objectFit='cover' alt='Dan Abramov' border='1px solid #ccc' />
          </Box>
          <Box>
