  ...
  return (
    ...
    >
      ...
      {selectedImage?.url && (
        ...
        >
          <Text fontSize="xs" color="text.textDelete" fontWeight="semibold">
            Bỏ chọn ảnh
          </Text>
          <CloseSmallIcon size={4} color="text.textDelete" />
        </Flex>
      )}
    </Box>
  );
