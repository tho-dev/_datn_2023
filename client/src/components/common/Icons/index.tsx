...
export const PictureIcon = ({ size = 46, strokeWidth = 1.5, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={strokeWidth} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M6.286 4h11.428A2.286 2.286 0 0 1 20 6.286v11.428A2.286 2.286 0 0 1 17.714 20H6.286A2.286 2.286 0 0 1 4 17.714V6.286A2.286 2.286 0 0 1 6.286 4Z' clipRule='evenodd' />
...
export const OrderIcon = ({ size = 32, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
...
export const CheckedIcon = ({ size = 35, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
...
export const PlusCircleIcon = ({ size = 35, strokeWidth = 1.5, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={strokeWidth} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M11.429 21.714c5.072 0 9.143-4.03 9.143-9.102S16.5 3.43 11.428 3.43s-9.143 4.111-9.143 9.183 4.07 9.102 9.143 9.102Z' clipRule='evenodd' />
...
export const Share = ({ size = 35, strokeWidth = 1.5, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={strokeWidth} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M19.429 4.571a2.424 2.424 0 0 1 0 3.429L8.57 18.857 4 20l1.143-4.507L16.004 4.576a2.418 2.418 0 0 1 3.274-.143l.15.138Z' clipRule='evenodd' />
...
export const StarNocolor = ({ size = 7, strokeWidth = 1.5, color = '#c7c7ca', ...props }) => (
  <Icon stroke='#c7c7ca' fill='#c7c7ca' strokeWidth={strokeWidth} viewBox='0 0 24 24' color='#FFC400' width={size} height={size} xmlns='http://www.w3.org/2000/svg' {...props}>
...
export const Star = ({ size = 30, strokeWidth = 1.5, color = 'rgb(255, 196, 0)', ...props }) => (
  <Icon stroke='currentColor' fill='currentColor' strokeWidth={strokeWidth} viewBox='0 0 24 24' color='#FFC400' width={size} height={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M6.255 20.452c-.464.237-.99-.18-.896-.71l.996-5.677-4.227-4.027c-.395-.377-.19-1.065.34-1.14l5.877-.835 2.62-5.192a.616.616 0 0 1 1.113 0L14.7 8.063l5.878.835c.529.075.734.763.338 1.14l-4.226 4.027.996 5.676c.093.532-.432.948-.896.71l-5.269-2.707-5.267 2.708h.002Z' />
  </Icon>
);
