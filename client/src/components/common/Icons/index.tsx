...
export const ArrowUpIcon = ({ size = 33, strokeWidth = 1.5, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={strokeWidth} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
...
export const ArrowLeftIcon = ({ size = 33, strokeWidth = 1.5, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill='none' stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={strokeWidth} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
...
export const PhoneIcon = ({ size = 33, strokeWidth = 1.5, color = 'currentColor', ...props }) => (
  <Icon width={size} height={size} fill={color} strokeWidth={strokeWidth} viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' {...props}>
