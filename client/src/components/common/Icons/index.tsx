...
export const TagIcon = ({ size = 35, color = "currentColor", ...props }) => (
	<Icon width={size} height={size} fill={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
		<path fill="currentColor" stroke="none" d="M15 8a1 1 0 1 0 0 2 1 1 0 1 0 0-2z" />
...
export const AddAdminIcon = ({ size = 35, color = "currentColor", ...props }) => (
	<Icon xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 28 27" fill="none" {...props}>
		<path
			fillRule="evenodd"
			clipRule="evenodd"
...
export const PicIcon = ({ size = 35, strokeWidth = 1.5, color = "currentColor", ...props }) => (
	<Icon
		...
		{...props}
	>
		<path d="M3.5 4h17a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-17a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Z" clipRule="evenodd" />
...
export const CloseIcon = ({ size = 35, ...props }) => (
	<Icon width={size} height={size} fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
