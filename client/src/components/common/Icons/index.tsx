...
export const ExcelIcon = ({ size = 47, strokeWidth = 1, color = "#000000", ...props }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
		...
		{...props}
	>
		<path d="M4 7.5V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-4.5" />
		<path d="M15.5 7.5H17" />
		<path d="M14 11.5h3" />
		<path d="M14 15.5h3" />
		<path d="M11 7.5H2v9h9v-9Z" />
		<path d="m5 10.5 3 3" />
		<path d="m8 10.5-3 3" />
	</Icon>
);
...
export const ArrowUpIcon = ({ size = 33, strokeWidth = 1.5, color = "currentColor" }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const PlusIcon = ({ size = 35, strokeWidth = 1.5, color = "currentColor" }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const CheckedIcon = ({ size = 35, color = "currentColor" }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const LaptopIcon = ({ size = 35, color = "currentColor" }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const SmartPhoneIcon = ({ size = 35, color = "currentColor" }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const CloseIcon = ({ size = 35 }) => (
	<Icon
		width={size}
		height={size}
		fill="currentColor"
...
export const CartNotFoundIcon = ({ size = 35 }) => (
	<Icon
		width={size}
		height={size}
		fill="currentColor"
...
export const ClockIcon = ({ size = 35 }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const HeadphoneIcon = ({ size = 35 }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const SoldOutIcon = ({ size = 47, strokeWidth = 1, color = "#000000", ...props }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
...
export const CopyIcon = ({ size = 47, strokeWidth = 1, color = "#000000", ...props }) => (
	<Icon
		width={size}
		height={size}
		fill="none"
