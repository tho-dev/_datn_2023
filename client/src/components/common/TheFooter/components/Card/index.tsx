...
const Card = ({ title, items }: Props) => {
  return (
    <Box h="full" p="4" rounded="md" backgroundColor="bg.gray">
      <Heading as="h2" color="text.black" fontSize="md" fontWeight="semibold">
        {title}
      </Heading>
      <Flex mt="3" flexDir="column">
        {items?.length ? (
          items?.map((item: any, index: number) => {
            ...
            return (
              <Flex
                ...
                fontWeight="medium"
              >
                <Icon size={4} strokeWidth={2} color="text.blue" />
          ...
          <>
            <Text fontSize="sm" color="text.black" fontWeight="medium">
