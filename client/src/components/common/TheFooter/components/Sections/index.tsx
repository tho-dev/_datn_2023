...
const Sections = ({ title }: Props) => {
  return (
    <Box mt="6">
      ...
      >
        <GridItem>
          <Card title="Đa dạng thanh toán" items={payment} />
        </GridItem>
        <GridItem>
          <Card title="Thông tin hữu ích" items={posts} />
        </GridItem>
        <GridItem>
          <Card title="Social networks" items={social} />
        </GridItem>
        <GridItem>
          <Card title="Phản hồi, góp ý, khiếu nại" items={[]} />
        </GridItem>
      </Grid>
    </Box>
  );
