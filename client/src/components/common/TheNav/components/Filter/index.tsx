...
const Filter = ({ items, category }: Props) => {
  return (
    <>
      <Box flex="1" px="6" py="5" bgColor="bg.gray" rounded="md" maxH="auto">
        <Link
        ...
        >
          <Flex flex="1" flexDir="column">
            <Text fontSize="md" color="text.black" fontWeight="semibold">
        ...
        {usps?.map((item: any, index: number) => {
          return (
            ...
            >
              ...
              <Box w="20" h="20" position="absolute" right="4" bottom="4">
